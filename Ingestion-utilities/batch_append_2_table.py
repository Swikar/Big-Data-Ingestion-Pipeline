...
try:
    ...
    SQL_STR += ' AND file_id NOT LIKE "8%" AND file_id != "11" AND file_id != "12"'
    SQL_STR += ' AND file_id NOT LIKE "2%" AND file_id NOT LIKE "3%"'
    if(P_FILE_ID != None):
    ...
    for (file_id, file_name, ext_table_name, delim, input_path, hive_db) in files:
        ...
        try:
            ...
            command = ["python", "append_2_table.py", str(f_id), str(f_id)+'0', '20170426', 'mr']
